...
# Streamlit的用户界面
st.title("Early Neurological Deterioration (END) Risk Calculator")
...
# tSAH: 分类选择
Severe_tSAH = st.selectbox("Severe tSAH (Morris-Marshall Grades 3 or 4):", options=[0, 1], format_func=lambda x: 'No (0)' if x == 0 else 'Yes (1)')
